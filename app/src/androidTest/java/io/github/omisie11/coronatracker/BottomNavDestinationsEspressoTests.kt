...
class BottomNavDestinationsEspressoTests {
    ...
    fun clickOnBottomNavOpenGlobalScreen() {
        ...
        onView(withId(R.id.pie_chart_global))
            .check(matches(isDisplayed()))
        onView(withId(R.id.image_recovered))
            .check(matches(isDisplayed()))
        onView(withId(R.id.image_confirmed))
            .check(matches(isDisplayed()))
        onView(withId(R.id.image_deaths))
            .check(matches(isDisplayed()))
        onView(withId(R.id.text_recovered))
            .check(matches(isDisplayed()))
        onView(withId(R.id.text_confirmed))
            .check(matches(isDisplayed()))
        onView(withId(R.id.text_deaths))
            .check(matches(isDisplayed()))
    }
